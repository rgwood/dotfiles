...
history: {
  ...
  keybindings: [
        ...
        # Reilly's custom keybindings come after this
        {
          name: build
          modifier: control
          keycode: char_b
          mode: emacs
          event: { send: executehostcommand, cmd: "build-current-project" }
        }
        # TODO: why don't these 2 shortcuts work (WezTerm on Windows, Windows Terminal)?
        {
          name: run
          modifier: control
          keycode: enter
